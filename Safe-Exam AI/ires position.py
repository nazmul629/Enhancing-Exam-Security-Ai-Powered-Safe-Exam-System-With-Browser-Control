...
look_timeleft_total = 0
total_look_timeright = 0; 
total_look_timecenter = 0; 
...
def iris_position(iris_center,right_point, left_point,look_timeleft_total=0):
    ...
    if ratio<= 0.50:
        ...
        look_timeleft = time.time() - start_time
        look_timeleft_total += int(look_timeleft)
